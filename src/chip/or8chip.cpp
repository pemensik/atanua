...
OR8Chip::OR8Chip(int aUS)
{
    ...
    if (aUS)
        mTexture = load_file_texture("data/or8_us.png");
    else
        mTexture = load_file_texture("data/or8_fi.png");
...
void OR8Chip::render(int aChipId)
{
	if (gBlackBackground)
...
void OR8Chip::update(float aTick) 
{
