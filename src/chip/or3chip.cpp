...
OR3Chip::OR3Chip(int aUS)
{
    ...
    if (aUS)
        mTexture = load_file_texture("data/or3_us.png");
    else
        mTexture = load_file_texture("data/or3_fi.png");
...
void OR3Chip::render(int aChipId)
{
	if (gBlackBackground)
...
void OR3Chip::update(float aTick) 
{
