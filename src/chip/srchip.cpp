...
SRChip::SRChip()
{
    ...
    mInputPinA.set(0, 0.25, this, "Set input");
    mPin.push_back(&mInputPinB);
    mInputPinB.set(0, 1.25, this, "Reset input");
    ...
    mTexture = load_file_texture("data/sr.png");
    mOldState = 0;
...
void SRChip::render(int aChipId)
{
	if (gBlackBackground)
...
void SRChip::update(float aTick) 
{
