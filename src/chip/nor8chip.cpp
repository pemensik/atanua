...
NOR8Chip::NOR8Chip(int aUS)
{
    ...
    if (aUS)
        mTexture = load_file_texture("data/nor8_us.png");
    else
        mTexture = load_file_texture("data/nor8_fi.png");
...
void NOR8Chip::render(int aChipId)
{
	if (gBlackBackground)
...
void NOR8Chip::update(float aTick) 
{
