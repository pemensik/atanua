...
Chip309::Chip309()
{
    ...
    mTexture[0] = load_file_texture("data/309.png");
    mTexture[1] = load_file_texture("data/309_b.png");
    mTexture[2] = load_file_texture("data/309_c.png");
    mTexture[3] = load_file_texture("data/309_d.png");
    mTexture[4] = load_file_texture("data/309_e.png");
    mTexture[5] = load_file_texture("data/309_f.png");
    mTexture[6] = load_file_texture("data/309_a.png");
    mTexture[7] = load_file_texture("data/309_g.png");
    mTexture[8] = load_file_texture("data/309_h.png");
