...
NAND8Chip::NAND8Chip(int aUS)
{
    ...
    if (aUS)
        mTexture = load_file_texture("data/nand8_us.png");
    else
        mTexture = load_file_texture("data/nand8_fi.png");
...
void NAND8Chip::render(int aChipId)
{
	if (gBlackBackground)
...
void NAND8Chip::update(float aTick) 
{
