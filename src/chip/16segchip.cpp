...
SixteenSegChip::SixteenSegChip(int aColor, int aInverse)
{
    ...
    mTexture[0] = load_file_texture("data/16seg_base.png");
    mTexture[1] = load_file_texture("data/16seg_a1.png");
    mTexture[2] = load_file_texture("data/16seg_a2.png");
    mTexture[3] = load_file_texture("data/16seg_j.png");
    mTexture[4] = load_file_texture("data/16seg_h.png");
    mTexture[5] = load_file_texture("data/16seg_f.png");
    mTexture[6] = load_file_texture("data/16seg_e.png");
    mTexture[7] = load_file_texture("data/16seg_n.png");
    mTexture[8] = load_file_texture("data/16seg_d1.png");
    mTexture[9] = load_file_texture("data/16seg_d2.png");
    mTexture[10] = load_file_texture("data/16seg_k.png");
    mTexture[11] = load_file_texture("data/16seg_b.png");
    mTexture[12] = load_file_texture("data/16seg_g1.png");
    mTexture[13] = load_file_texture("data/16seg_g2.png");
    mTexture[14] = load_file_texture("data/16seg_c.png");
    mTexture[15] = load_file_texture("data/16seg_l.png");
    mTexture[16] = load_file_texture("data/16seg_m.png");
    mTexture[17] = load_file_texture("data/16seg_dp.png");
}
