...
NOR3Chip::NOR3Chip(int aUS)
{
    ...
    if (aUS)
        mTexture = load_file_texture("data/nor3_us.png");
    else
        mTexture = load_file_texture("data/nor3_fi.png");
...
void NOR3Chip::render(int aChipId)
{
	if (gBlackBackground)
...
void NOR3Chip::update(float aTick) 
{
