...
AND3Chip::AND3Chip(int aUS)
{
    ...
    if (aUS)
        mTexture = load_file_texture("data/and3_us.png");
    else
        mTexture = load_file_texture("data/and3_fi.png");
...
void AND3Chip::render(int aChipId)
{
	if (gBlackBackground)
...
void AND3Chip::update(float aTick) 
{
