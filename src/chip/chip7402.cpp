...
Chip7402::Chip7402()
{
    ...
    mOutputPin[0].set(xpos, 0, this, "Pin 13:Y4"); xpos += 0.54;
    mPin.push_back(&mInputPinB[0]);
    mInputPinB[0].set(xpos, 0, this, "Pin 12:B4"); xpos += 0.54;
    mPin.push_back(&mInputPinA[0]);
    mInputPinA[0].set(xpos, 0, this, "Pin 11:A4"); xpos += 0.54;

    mPin.push_back(&mOutputPin[1]);
    mOutputPin[1].set(xpos, 0, this, "Pin 10:Y3"); xpos += 0.54;
    mPin.push_back(&mInputPinB[1]);
    mInputPinB[1].set(xpos, 0, this, "Pin 9:B3"); xpos += 0.54;
    mPin.push_back(&mInputPinA[1]);
    mInputPinA[1].set(xpos, 0, this, "Pin 8:A3"); xpos += 0.54;

    xpos = 0.15;
    mPin.push_back(&mOutputPin[2]);
    mOutputPin[2].set(xpos, 1.5, this, "Pin 1:Y1"); xpos += 0.54;
    mPin.push_back(&mInputPinB[2]);
    mInputPinB[2].set(xpos, 1.5, this, "Pin 2:A1"); xpos += 0.54;
    mPin.push_back(&mInputPinA[2]);
    mInputPinA[2].set(xpos, 1.5, this, "Pin 3:B1"); xpos += 0.54;

    mPin.push_back(&mOutputPin[3]);
    mOutputPin[3].set(xpos, 1.5, this, "Pin 4:Y2"); xpos += 0.54;
    mPin.push_back(&mInputPinB[3]);
    mInputPinB[3].set(xpos, 1.5, this, "Pin 5:A2"); xpos += 0.54;
    mPin.push_back(&mInputPinA[3]);
    mInputPinA[3].set(xpos, 1.5, this, "Pin 6:B2"); xpos += 0.54;

    mTexture = load_file_texture("data/chip_14pin.png");
}

void Chip7402::render(int aChipId)
{
    drawtexturedrect(mTexture,mX,mY,mW,mH,0xffffffff);
    fn.drawstring("74LS02",mX+0.6,mY+0.6,0x5fffffff,0.75);
}

void Chip7402::update(float aTick) 
{
    int i;
    for (i = 0; i < 4; i++)
    {
