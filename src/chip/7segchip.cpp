...
SevenSegChip::SevenSegChip(int aColor, int aInverse)
{
    ...
    mTexture[0] = load_file_texture("data/7seg_base.png");
    mTexture[1] = load_file_texture("data/7seg_a.png");
    mTexture[2] = load_file_texture("data/7seg_b.png");
    mTexture[3] = load_file_texture("data/7seg_c.png");
    mTexture[4] = load_file_texture("data/7seg_d.png");
    mTexture[5] = load_file_texture("data/7seg_e.png");
    mTexture[6] = load_file_texture("data/7seg_f.png");
    mTexture[7] = load_file_texture("data/7seg_g.png");
    mTexture[8] = load_file_texture("data/7seg_h.png");
